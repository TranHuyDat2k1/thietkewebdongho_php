            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="form-group">
                      <label for="nhacungcap">Ten Nha Cung Cap</label>
                      <input type="text"
                        class="form-control" id="nhacungcap" ng-model="nhacungcap.TenNCC">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text"
                          class="form-control" id="diachi" ng-model="nhacungcap.DiaChi">
                      </div>
                </div>
    ...
    <script>
        ...
        app.controller('mycontroller',function($scope,$http){
            ...
            $scope.showModal = function(id){
                $scope.id=id;
                if(id==0){
                    $scope.modalTitle = "Them nha cung cap";

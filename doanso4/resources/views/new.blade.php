            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="form-group">
                      <label for="idnewname">id_new</label>
                      <input type="text"
                        class="form-control" id="idnewname" ng-model="new.id_new">
                    </div>
                <div class="form-group1">
                        <label for="title">Title</label>
                        <input type="text"
                          class="form-control" id="title" ng-model="new.title">
                      </div>
                </div>
                <div class="form-group2">
                        <label for="content">Content</label>
                        <input type="text"
                          class="form-control" id="content" ng-model="new.content">
                      </div>
                </div>
                <div class="form-group3">
                        <label for="image">Image</label>
                        <input type="text"
                          class="form-control" id="image" ng-model="new.image">
                      </div>
                </div>
    ...
    <script>
        ...
        app.controller('mycontroller',function($scope,$http){
            ...
            $scope.showModal = function(id){
                $scope.id=id;
                if(id==0){
                    $scope.modalTitle = "Them new";
                    if($scope.new) delete $scope.new;
                }
                else{
                    $scope.modalTitle = "Sua new";
                    $http(
                        {
                            method: "GET",

...
<div class="top_bg">
	<div class="container">
		<div class="header_top">
			...
			<div class="top_left">
				<h2><span></span> Gọi Cho Chúng Tôi : 039 618 9219</h2>
			</div>
...
<div class="container">
	...
	<div class="head-t">
		<div class="logo">
			<a href="http://localhost:8000/details"><img src="../user/images/logo.png" class="img-responsive" alt=""/> </a>
		</div>
		<!-- start header_right -->
		<div class="header_right">
			<div class="rgt-bottom">
				<div class="log">
					<div class="login" >
						<div id="loginContainer"><a href="http://localhost:8000/login" data-hover="hover">Đăng Nhập</a>
						    <div id="loginBox">                
						        <form id="loginForm">
						                <fieldset id="body">
						                	<fieldset>
						                	...
						                	<label for="checkbox"><input type="checkbox" id="checkbox"> <i>Nhớ</i></label>
						            	</fieldset>
				...
				<div class="reg">
					<a href="http://localhost:8000/register" data-hover="hover">Đăng Kí</a>
				</div>
			<div class="cart box_1">
				<a href="http://localhost:8000/checkout">
					<h3> <span class="simpleCart_total">$0.00</span> (<span id="simpleCart_quantity" class="simpleCart_quantity">0</span> items)<img src="../user/images/bag.png" alt=""></h3>
				</a>	
				<p><a href="javascript:;" class="simpleCart_empty">(Thẻ Trống)</a></p>
				<div class="clearfix"> </div>
			</div>
			<div class="create_btn">
				<a href="http://localhost:8000/checkout">Thanh Toán</a>
			</div>
			<div class="clearfix"> </div>
		</div>
		<div class="search">
		...
		<ul class="megamenu skyblue">
			<li class="active grid"><a class="color1" href="http://localhost:8000/index">Trang Chính</a></li>
			<li class="grid"><a class="color2" href="#">Đồng Hồ Nam</a>
				<!-- <div class="megapanel">
					<div class="row">
						<div class="col1">
							<div class="h_nav">
			...
			<li><a class="color4" href="#">Đồng Hồ Nữ</a>
				...
				<li><a class="color5" href="#" >Đồng Hồ Đôi</a>
				<!-- <div class="megapanel">
					<div class="row">
						<div class="col1">
							<div class="h_nav">
				...
				<li><a class="color6" href="#">Đồng Hồ Nổi Bật</a>
				<!-- <div class="megapanel">
					<div class="row">
						<div class="col1">
							<div class="h_nav">
				...
				<li><a class="color7" href="#">Tin Tức </a>
				<!-- <div class="megapanel">
					<div class="row">
						<div class="col1">
							<div class="h_nav">
				...
				<li><a class="color8" href="#">Liên Hệ</a>
				<!-- <div class="megapanel">
					<div class="row">
						<div class="col1">
							<div class="h_nav">
	...
	<div class="col-md-9 w_content">
		...
		<div class="grids_of_4">
		  <div class="grid1_of_4">
				<div class="content_box"><a href="http://localhost:8000/details">
			   	   	 <img src="user/images/w1.jpg" class="img-responsive" alt=""/>
				   	  </a>
				    <h4><a href="http://localhost:8000/details"> Duis autem</a></h4>
			...
			<div class="grid1_of_4">
				<div class="content_box"><a href="http://localhost:8000/details">
			   	   	 <img src="user/images/w2.jpg" class="img-responsive" alt=""/>
				   	  </a>
				    <h4><a href="http://localhost:8000/details"> Duis autem</a></h4>
				     <p>It is a long established fact that</p>
					 <div class="grid_1 simpleCart_shelfItem">
			...
			<div class="grid1_of_4">
				<div class="content_box"><a href="http://localhost:8000/details">
			   	   	 <img src="user/images/w3.jpg" class="img-responsive" alt=""/>
				   	  </a>
				    <h4><a href="http://localhost:8000/details"> Duis autem</a></h4>
				     <p>It is a long established fact that</p>
					 <div class="grid_1 simpleCart_shelfItem">
		...
		<div class="grids_of_4">
		 <div class="grid1_of_4">
				<div class="content_box"><a href="http://localhost:8000/details">
			   	   	 <img src="user/images/w5.jpg" class="img-responsive" alt=""/>
				   	  </a>
				    <h4><a href="http://localhost:8000/details"> Duis autem</a></h4>
				     <p>It is a long established fact that</p>
					 <div class="grid_1 simpleCart_shelfItem">
			...
			<div class="grid1_of_4">
				<div class="content_box"><a href="http://localhost:8000/details">
			   	   	 <img src="user/images/w6.jpg" class="img-responsive" alt=""/>
				   	  </a>
				    <h4><a href="http://localhost:8000/details"> Duis autem</a></h4>
				     <p>It is a long established fact that</p>
					 <div class="grid_1 simpleCart_shelfItem">
			...
			<div class="grid1_of_4">
				<div class="content_box"><a href="http://localhost:8000/details">
			   	   	 <img src="user/images/w7.jpg" class="img-responsive" alt=""/>
				   	  </a>
				    <h4><a href="http://localhost:8000/details"> Duis autem</a></h4>
				     <p>It is a long established fact that</p>
					 <div class="grid_1 simpleCart_shelfItem">
			...
			<div class="grid1_of_4">
				<div class="content_box"><a href="http://localhost:8000/details">
			   	   	 <img src="user/images/w8.jpg" class="img-responsive" alt=""/>
				   	  </a>
				    <h4><a href="http://localhost:8000/details"> Duis autem</a></h4>
				     <p>It is a long established fact that</p>
					 <div class="grid_1 simpleCart_shelfItem">
		...
		<div class="grids_of_4">
		  <div class="grid1_of_4">
				<div class="content_box"><a href="http://localhost:8000/details">
			   	   	 <img src="user/images/w9.jpg" class="img-responsive" alt=""/>
				   	  </a>
				    <h4><a href="http://localhost:8000/details"> Duis autem</a></h4>
				     <p>It is a long established fact that</p>
					 <div class="grid_1 simpleCart_shelfItem">
			...
			<div class="grid1_of_4">
				<div class="content_box"><a href="http://localhost:8000/details">
			   	   	 <img src="user/images/w10.jpg" class="img-responsive" alt=""/>
				   	  </a>
				    <h4><a href="http://localhost:8000/details"> Duis autem</a></h4>
				     <p>It is a long established fact that</p>
					 <div class="grid_1 simpleCart_shelfItem">
			...
			<div class="grid1_of_4">
				<div class="content_box"><a href="http://localhost:8000/details">
			   	   	 <img src="user/images/w11.jpg" class="img-responsive" alt=""/>
				   	  </a>
				    <h4><a href="http://localhost:8000/details"> Duis autem</a></h4>
				     <p>It is a long established fact that</p>
					 <div class="grid_1 simpleCart_shelfItem">
			...
			<div class="grid1_of_4">
				<div class="content_box"><a href="http://localhost:8000/details">
			   	   	 <img src="user/images/w12.jpg" class="img-responsive" alt=""/>
				   	  </a>
				    <h4><a href="http://localhost:8000/details"> Duis autem</a></h4>
				     <p>It is a long established fact that</p>
					 <div class="grid_1 simpleCart_shelfItem">
	...
	<div class="container">
		...
		<div class="col-md-6 s-c">
			<div class="stay">
						<div class="stay-left">
							<form>
								<input type="text" placeholder="Nhập Email của bạn để tham gia bản tin của chúng tôi" required="">
							</form>
						</div>
						<div class="btn-1">
							<form>
	...
	<div class="container">
		<div class="col-md-3 cust">
			<h4>Chăm Sóc Khách Hàng</h4>
				...
				<li><a href="buy.html">Mua thế nào</a></li>
		...
		<div class="col-md-2 abt">
			<h4>Về Chúng Tôi</h4>
				...
				<li><a href="contact.html">Tiếp xúc</a></li>
		</div>
		<div class="col-md-2 myac">
			<h4>Tài Khoản</h4>
				<li><a href="register">Tài Khoản </a></li>
				<li><a href="#">Đăng kí</a></li>
				<li><a href="#">Giỏ hàng </a></li>
				<li><a href="buy.html">Lịch sử đơn hàng </a></li>
		</div>
		<div class="col-md-5 our-st">
			...
			<div class="clearfix"> </div>
				<li><i class="add"> </i>Phùng Hưng - Khoái Châu - Hưng Yên</li>
				<li><i class="phone"> </i>0396189219</li>
				<li><a href="mailto:lionkingday2001@gmail.com"><i class="mail"> </i>lionkingday2001@gmail.com</a></li>
			
		</div>
		<div class="clearfix"> </div>
			<p>Copyrights © 2022 DatKem </a></p>
	</div>
</div>
</body>
</html>